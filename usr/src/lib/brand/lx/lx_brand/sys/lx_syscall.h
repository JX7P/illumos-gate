...
extern int lx_syncfs(uintptr_t);
...
/* and the following syscalls are for 3.0 and greater kernels */
#define LX_SYS_get_cpu		318
#define LX_SYS_epoll_wait	319
...
#define LX_SYS_rt_tsigqueueinfo	335
